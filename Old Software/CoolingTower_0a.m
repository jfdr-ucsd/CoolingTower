...
dispGetTemps = uicontrol('Parent', panelSchema, ...
    'Style','togglebutton',...
    'String', 'Temp Acq',...
...
% This block is for binary on/off switches
